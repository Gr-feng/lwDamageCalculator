...
TRIBE_CSV_PATH = resource_path("tribe_extracted.csv")
BUFF_XLSX_PATH = resource_path("LW全技能总览.xlsx")
TRANSLATED_CHARACTER_CSV_PATH = resource_path("touhou_characters_translated.csv")
EQUIPMENT_TXT_PATH = resource_path("绘卷buff03-26.txt")
EQUIPMENT_JSON_PATH = resource_path("equipment_data.json")
RECOMMENDED_EQUIPMENT_CSV_PATH = resource_path("recommended.csv")
LOCAL_TRANSLATIONS_JSON_PATH = resource_path("local_translations.json")
BUFF_TRANSLATION_CSV_PATH = resource_path("buff_translation.csv")
